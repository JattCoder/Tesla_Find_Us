class Location
    ...
    def initialize
        ...
        @@superchargers = @res_hash["results"]
        binding.pry
    end
    ...
    def self.find(str)
        ...
        @res_hash["results"].each do |charger|
            if charger["address"]["city"].downcase == str.downcase || charger["address"]["zip"].downcase == str.downcase || charger["address"]["state"].downcase == str.downcase
